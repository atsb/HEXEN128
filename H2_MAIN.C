...
static void ExecOptionWARP(char **args, int tag);
#endif
...
//#ifdef TIMEBOMB
#if (defined TIMEBOMB) || (defined APPVER_DEMO)
...
#if (APPVER_HEXENREV < AV_HR_HEX10A) // Moved and modified below
	if(autostart)
	{
		ST_Message("Warp to Map %d, Skill %d\n", startmap, startskill+1);
	}
#endif
...
#endif
{
...
#endif
	{
		...
		if(map == -1)
#else
		startmap = atoi(args[1]);
		if(startmap < 1 || startmap > 99)
#endif
...
{
#ifdef __WATCOMC__
#ifndef APPVER_DEMO // VERSIONS RESTORATION: Repurpose function
	time_t timeOfDay;
	...
	printf("\n===============================================================================\n");
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA) // Looks like this was changed later
	printf("                                   HEXEN BETA\n");
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
	printf("                             Hexen:  Beyond Heretic\n");
	printf("                              4 Level Beta Release\n\n");
#else
	printf("                             Hexen:  Beyond Heretic\n\n");
	printf("                              4 Level Demo Version\n");
#endif
	printf("                           Press any key to continue.\n");
	printf("===============================================================================\n");
#endif
