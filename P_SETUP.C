...
#define DEFAULT_SKY_NAME "SKY2"
#else
#define DEFAULT_SKY_NAME "SKY4"
#endif
...
#if (defined __WATCOMC__) && (APPVER_HEXENREV >= AV_HR_HEX10B)
...
void P_SetupLevel(int episode, int map, int playermask, skill_t skill)
{
	...
	S_Start();
#else
#if (APPVER_HEXENREV >= AV_HR_HEX10B)
	if(i_CDMusic == false)
#endif
	{
...
#if (APPVER_HEXENREV >= AV_HR_HEX11A) // VERSIONS RESTORATION: Moved from R_PrecacheLevel
