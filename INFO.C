...
"ABK1","ABK2","ASK2","AFWP","ACWP","AMWP","AGER",
...
"TRE2","TRE3",
              ...
              "STM1","STM2",
#ifndef APPVER_DEMO
                            "STM3","STM4","MSH1","MSH2","MSH3","MSH4",
"MSH5","MSH6","MSH7","MSH8",
#endif
                            "SGMP","SGM1","SGM2","SGM3","SLC1","SLC2",
"SLC3","MSS1","MSS2",
#ifndef APPVER_DEMO
                     "SWMV",
#endif
                            "CPS1",
#ifndef APPVER_DEMO
                                   "CPS2","TMS1","TMS2","TMS3","TMS4",
"TMS5","TMS6","TMS7",
#endif
                     "CPS3","STT2","STT3","STT4","STT5","GAR1","GAR2",
"GAR3","GAR4","GAR5","GAR6","GAR7","GAR8","GAR9","BNR1","TRE4","TRE5",
#ifndef APPVER_DEMO
"TRE6","TRE7","LOGG",
#endif
                     "ICT1","ICT2","ICT3","ICT4","ICM1","ICM2","ICM3",
"ICM4","RKBL","RKBS","RKBK","RBL1","RBL2","RBL3",
#ifndef APPVER_DEMO
                                                 "VASE",
#endif
                                                        "POT1","POT2",
...
"XMAS",
#ifndef APPVER_DEMO
       "CDRN","CHNS","TST1","TST2","TST3","TST4","TST5","TST6","TST7",
"TST8","TST9","TST0",
#endif
                     "TELE","TSMK","FPCH","WFAX","FAXE","WFHM","FHMR",
...
"SHEX","BLOD",
              ...
              "GIBS",
#endif
                     "PLAY","FDTH","BSKL","ICEC","CLER","MAGE","PIGY",
"CENT","CTXD","CTFX","CTDP","DEMN","DEMA","DEMB","DEMC","DEMD","DEME",
"DMFX",
#ifndef APPVER_DEMO
       "DEM2","DMBA","DMBB","DMBC","DMBD","DMBE","D2FX","WRTH","WRT2",
"WRBL",
#endif
       "MNTR","FX12","FX13","MNSM",
#ifndef APPVER_DEMO
                                   "SSPT","SSDV","SSXD","SSFX","BISH",
"BPFX","DRAG","DRFX",
#endif
                     "ARM1","ARM2","ARM3","ARM4","MAN2","MAN3","KEY1",
"KEY2","KEY3","KEY4","KEY5","KEY6","KEY7","KEY8","KEY9","KEYA","KEYB",
#if (APPVER_HEXENREV < AV_HR_HEX10A)
"AFLY",
#endif
"ETTN","ETTB","FDMN","FDMB","ICEY","ICPR","ICWS",
#ifndef APPVER_DEMO
                                                 "SORC","SBMP","SBS4",
"SBMB","SBS3","SBMG","SBS1","SBS2","SBFX",
#endif
                                          "RADE","WATR"
#ifndef APPVER_DEMO
,"KORX","ABAT"
...
void A_DropMace ();
void A_FiredRocks ();
#if (APPVER_HEXENREV >= AV_HR_HEX10A) // VERSIONS RESTORATION: Later split
void A_UnSetInvulnerable ();
#endif
void A_FiredChase ();
void A_FiredAttack ();
...
#if (APPVER_HEXENREV >= AV_HR_HEX10A) // S_DORMANTARTI3_10 is the last otherwise
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_AGER,0,4,NULL,S_ARTIPUZZGEAR_2,0,0},	// S_ARTIPUZZGEAR_1
{SPR_AGER,1,4,NULL,S_ARTIPUZZGEAR_3,0,0},	// S_ARTIPUZZGEAR_2
{SPR_AGER,2,4,NULL,S_ARTIPUZZGEAR_4,0,0},	// S_ARTIPUZZGEAR_3
{SPR_AGER,3,4,NULL,S_ARTIPUZZGEAR_5,0,0},	// S_ARTIPUZZGEAR_4
{SPR_AGER,4,4,NULL,S_ARTIPUZZGEAR_6,0,0},	// S_ARTIPUZZGEAR_5
{SPR_AGER,5,4,NULL,S_ARTIPUZZGEAR_7,0,0},	// S_ARTIPUZZGEAR_6
{SPR_AGER,6,4,NULL,S_ARTIPUZZGEAR_8,0,0},	// S_ARTIPUZZGEAR_7
{SPR_AGER,7,4,NULL,S_ARTIPUZZGEAR_1,0,0},	// S_ARTIPUZZGEAR_8
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_CFCF,32784,4,A_Scream,S_THROWINGBOMB_X2,0,0},	// S_THROWINGBOMB_X1
{SPR_CFCF,32785,3,A_Explode,S_THROWINGBOMB_X3,0,0},	// S_THROWINGBOMB_X2
{SPR_CFCF,32786,4,NULL,S_THROWINGBOMB_X4,0,0},	// S_THROWINGBOMB_X3
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_CFFX,32781,12,NULL,S_NULL,0,0},	// S_CFLAMEFLOOR1
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_MSP2,32768,2,NULL,S_MSTAFF_FX2_2,0,0},	// S_MSTAFF_FX2_1
{SPR_MSP2,32769,2,NULL,S_MSTAFF_FX2_3,0,0},	// S_MSTAFF_FX2_2
{SPR_MSP2,32770,2,NULL,S_MSTAFF_FX2_4,0,0},	// S_MSTAFF_FX2_3
{SPR_MSP2,32771,2,NULL,S_MSTAFF_FX2_1,0,0},	// S_MSTAFF_FX2_4
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_FDTH,32778,5,A_PlayerBurn,S_PLAY_FDTH8,0,0},	// S_PLAY_FDTH7
#else
...
{SPR_PIGY,6,4,NULL,S_PIG_DIE4,0,0},	// S_PIG_DIE3
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_CENT,6,6,A_SetInvulnerable,S_CENTAUR_PAIN3,0,0},	// S_CENTAUR_PAIN2
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_CENT,4,1,A_UnSetInvulnerable,S_CENTAUR_WALK1,0,0},	// S_CENTAUR_PAIN6
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_CENT,17,4,NULL,S_CENTAUR_DEATH9,0,0},	// S_CENTAUR_DEATH8
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_CTXD,4,4,NULL,S_CENTAUR_DEATH_X6,0,0},	// S_CENTAUR_DEATH_X5
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX11A)
{SPR_CTDP,7,4,NULL,S_CENTAUR_SHIELD_X3,0,0},	// S_CENTAUR_SHIELD_X2
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX11A)
{SPR_CTDP,18,4,NULL,S_CENTAUR_SWORD_X3,0,0},	// S_CENTAUR_SWORD_X2
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_DEMN,11,6,NULL,S_DEMN_XDEATH6,0,0},	// S_DEMN_XDEATH5
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX11A)
{SPR_DEMA,0,20,NULL,S_DEMONCHUNK1_1,0,0},	// S_DEMONCHUNK1_1
{SPR_DEMA,0,-1,NULL,S_NULL,0,0},	// S_DEMONCHUNK1_2
{SPR_DEMB,0,20,NULL,S_DEMONCHUNK2_1,0,0},	// S_DEMONCHUNK2_1
{SPR_DEMB,0,-1,NULL,S_NULL,0,0},	// S_DEMONCHUNK2_2
{SPR_DEMC,0,20,NULL,S_DEMONCHUNK3_1,0,0},	// S_DEMONCHUNK3_1
{SPR_DEMC,0,-1,NULL,S_NULL,0,0},	// S_DEMONCHUNK3_2
{SPR_DEMD,0,20,NULL,S_DEMONCHUNK4_1,0,0},	// S_DEMONCHUNK4_1
{SPR_DEMD,0,-1,NULL,S_NULL,0,0},	// S_DEMONCHUNK4_2
{SPR_DEME,0,20,NULL,S_DEMONCHUNK5_1,0,0},	// S_DEMONCHUNK5_1
{SPR_DEME,0,-1,NULL,S_NULL,0,0},	// S_DEMONCHUNK5_2
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_DEM2,11,6,NULL,S_DEMN2_DEATH6,0,0},	// S_DEMN2_DEATH5
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_DEM2,11,6,NULL,S_DEMN2_XDEATH6,0,0},	// S_DEMN2_XDEATH5
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX11A)
{SPR_DMBA,0,20,NULL,S_DEMON2CHUNK1_1,0,0},	// S_DEMON2CHUNK1_1
{SPR_DMBA,0,-1,NULL,S_NULL,0,0},	// S_DEMON2CHUNK1_2
{SPR_DMBB,0,20,NULL,S_DEMON2CHUNK2_1,0,0},	// S_DEMON2CHUNK2_1
{SPR_DMBB,0,-1,NULL,S_NULL,0,0},	// S_DEMON2CHUNK2_2
{SPR_DMBC,0,20,NULL,S_DEMON2CHUNK3_1,0,0},	// S_DEMON2CHUNK3_1
{SPR_DMBC,0,-1,NULL,S_NULL,0,0},	// S_DEMON2CHUNK3_2
{SPR_DMBD,0,20,NULL,S_DEMON2CHUNK4_1,0,0},	// S_DEMON2CHUNK4_1
{SPR_DMBD,0,-1,NULL,S_NULL,0,0},	// S_DEMON2CHUNK4_2
{SPR_DMBE,0,20,NULL,S_DEMON2CHUNK5_1,0,0},	// S_DEMON2CHUNK5_1
{SPR_DMBE,0,-1,NULL,S_NULL,0,0},	// S_DEMON2CHUNK5_2
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_WRTH,13,4,NULL,S_WRAITH_DEATH1_7,0,0},	// S_WRAITH_DEATH1_6
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_WRT2,5,5,NULL,S_WRAITH_DEATH2_7,0,0},	// S_WRAITH_DEATH2_6
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_BISH,14,4,NULL,S_BISHOP_DEATH10,0,0},	// S_BISHOP_DEATH9
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_AFLY,0,20,A_FlyCheck,S_FLY1,0,0},	// S_FLY1
{SPR_AFLY,0,3,A_FlyMove,S_FLY3,0,0},	// S_FLY2
{SPR_AFLY,1,3,A_FlyMove,S_FLY4,0,0},	// S_FLY3
{SPR_AFLY,2,3,A_FlyMove,S_FLY5,0,0},	// S_FLY4
{SPR_AFLY,3,3,A_FlyMove,S_FLY2,0,0},	// S_FLY5
#endif
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_ETTN,12,4,NULL,S_ETTIN_DEATH1_6,0,0},	// S_ETTIN_DEATH1_5
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_ETTB,4,4,NULL,S_ETTIN_DEATH2_6,0,0},	// S_ETTIN_DEATH2_5
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX11A)
{SPR_ETTB,17,5,NULL,S_ETTIN_MACE7,0,0},	// S_ETTIN_MACE6
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX11A)
{SPR_FDMN,15,9,NULL,S_FIRED_CORPSE2,0,0},	// S_FIRED_CORPSE1
{SPR_FDMN,24,-1,NULL,S_NULL,0,0},	// S_FIRED_CORPSE2
{SPR_FDMN,16,9,NULL,S_FIRED_CORPSE4,0,0},	// S_FIRED_CORPSE3
{SPR_FDMN,25,-1,NULL,S_NULL,0,0},	// S_FIRED_CORPSE4
#else
...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
{SPR_ICPR,0,3,A_IceGuyMissilePuff,S_ICEGUY_FX2,0,0},	// S_ICEGUY_FX1
{SPR_ICPR,1,3,A_IceGuyMissilePuff,S_ICEGUY_FX3,0,0},	// S_ICEGUY_FX2
{SPR_ICPR,2,3,A_IceGuyMissilePuff,S_ICEGUY_FX1,0,0},	// S_ICEGUY_FX3
#else
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
{SPR_PLAY,0,4,A_Chase,S_FIGHTER_RUN2,0,0},	// S_FIGHTER_RUN1
{SPR_PLAY,1,4,A_Chase,S_FIGHTER_RUN3,0,0},	// S_FIGHTER_RUN2
{SPR_PLAY,2,4,A_Chase,S_FIGHTER_RUN4,0,0},	// S_FIGHTER_RUN3
{SPR_PLAY,3,4,A_Chase,S_FIGHTER_RUN1,0,0},	// S_FIGHTER_RUN4
#else
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
{SPR_CLER,0,4,A_Chase,S_CLERIC_RUN2,0,0},	// S_CLERIC_RUN1
{SPR_CLER,1,4,A_Chase,S_CLERIC_RUN3,0,0},	// S_CLERIC_RUN2
{SPR_CLER,2,4,A_Chase,S_CLERIC_RUN4,0,0},	// S_CLERIC_RUN3
{SPR_CLER,3,4,A_Chase,S_CLERIC_RUN1,0,0},	// S_CLERIC_RUN4
#else
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
{SPR_SBS4,3,5,NULL,S_SORCBALL1_D6,0,0},	// S_SORCBALL1_D5
{SPR_SBS4,4,5,NULL,S_SORCBALL1_D7,0,0},	// S_SORCBALL1_D6
{SPR_SBS4,5,2,A_Scream,S_SORCBALL1_D8,0,0},	// S_SORCBALL1_D7
{SPR_SBS4,6,2,A_Explode,S_SORCBALL1_D9,0,0},	// S_SORCBALL1_D8
{SPR_SBS4,7,2,NULL,S_NULL,0,0},	// S_SORCBALL1_D9
#else
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
{SPR_SBS3,3,5,NULL,S_SORCBALL2_D6,0,0},	// S_SORCBALL2_D5
{SPR_SBS3,4,5,NULL,S_SORCBALL2_D7,0,0},	// S_SORCBALL2_D6
{SPR_SBS3,5,2,A_Scream,S_SORCBALL2_D8,0,0},	// S_SORCBALL2_D7
{SPR_SBS3,6,2,A_Explode,S_SORCBALL2_D9,0,0},	// S_SORCBALL2_D8
{SPR_SBS3,7,2,NULL,S_NULL,0,0},	// S_SORCBALL2_D9
#else
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
{SPR_SBS3,3,5,NULL,S_SORCBALL3_D6,0,0},	// S_SORCBALL3_D5
{SPR_SBS3,4,5,NULL,S_SORCBALL3_D7,0,0},	// S_SORCBALL3_D6
{SPR_SBS3,5,2,A_Scream,S_SORCBALL3_D8,0,0},	// S_SORCBALL3_D7
{SPR_SBS3,6,2,A_Explode,S_SORCBALL3_D9,0,0},	// S_SORCBALL3_D8
{SPR_SBS3,7,2,NULL,S_NULL,0,0},	// S_SORCBALL3_D9
#else
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
{SPR_FHFX,32786,2,A_Scream,S_SORCFX1_D2,0,0},	// S_SORCFX1_D1
{SPR_FHFX,32786,2,A_Explode,S_NULL,0,0},	// S_SORCFX1_D2
#else
...
MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY,		// flags
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
MF2_NOTELEPORT|MF2_RIP|MF2_IMPACT|MF2_PCROSS		// flags2
#else
...
MF_NOBLOCKMAP|MF_MISSILE|MF_DROPOFF|MF_NOGRAVITY,		// flags
#if (APPVER_HEXENREV < AV_HR_HEX10A)
MF2_NOTELEPORT|MF2_FIREDAMAGE|MF2_IMPACT|MF2_PCROSS		// flags2
#else
...
2,		// mass
0,		// damage
SFX_FLY_BUZZ,		// activesound
MF_DROPOFF|MF_NOGRAVITY|MF_NOBLOCKMAP,		// flags
MF2_PASSMOBJ		// flags2
 },
#endif // APPVER_HEXENREV < AV_HR_HEX10A
...
SFX_NONE,		// activesound
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
MF_SOLID|MF_SHOOTABLE|MF_DROPOFF|MF_COUNTKILL,		// flags
MF2_FLOORCLIP|MF2_PASSMOBJ|MF2_BOSS|MF2_TELESTOMP|MF2_PUSHWALL|MF2_MCROSS		// flags2
#else
MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,		// flags
...
S_NULL,		// xdeathstate
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
SFX_SORCERER_BIGBALLEXPLODE,		// deathsound
#else
SFX_NONE,		// deathsound
#endif
10*FRACUNIT,		// speed
...
#if (APPVER_HEXENREV < AV_HR_HEXDEMOA)
SFX_SORCERER_HEADSCREAM,		// deathsound
#else
SFX_NONE,		// deathsound
#endif
7*FRACUNIT,		// speed
