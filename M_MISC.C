...
#if (APPVER_HEXENREV < AV_HR_HEX10A)
unsigned char unusedrndtable[256] = {
	110,205, 30,200,190,100, 70,170,110,100, 85,100,145,225,115, 50,
	165,175,195,155,125, 90,155,200,100,130, 95,125,180,135,155,130,
	155,120, 85,115,135,120, 75,145,105, 80,115, 35,105,125,170,105,
	245,135, 75, 55,150, 35,140, 75,235,190, 70,135,220,150, 65,135,
	120, 15,120, 80,135, 25,125, 60, 35, 40,140,175,105,185,135, 45,
	120,130, 80,115,205,225, 85,140,120,105,120,165, 90,145,105,105,
	175,165,140,165,100,185,110, 45,115, 75, 10,150,215, 80,245, 30,
	140,150,180,100,210, 40,180,130, 95,115,195,160, 70, 45, 90,160,
	150,115,155, 90, 10,150, 25, 85, 60,115, 95, 60, 85,145,120, 55,
	 95,175,185, 50,125,175, 60,140, 70, 80,195,145,125,155,210, 70,
	 85,115,170,115,180,110, 80,150,170,100, 55,160, 95, 95,130,205,
	155,110,105,220,110,185,140, 75, 90,215,125, 55,200, 50,195,125,
	176,140,190,130, 50, 95,120,110,125,200, 75, 65, 80,180, 90,230, 
	140, 90,160, 20,185,170,145, 40,135,105, 65,190,135,135,180,130,
	145,215,165,145, 60,110, 65,145, 65,110, 95,165, 85,160, 70,160,
	130,130,100,210,160,190,165,125,130,120,170,175,150,125,155,170
};

int unusedrndindex = 0;
#endif
...
#pragma aux SemiFixedMulForRand = \
	"imul eax, edx" \
	"sar eax,16" \
        parm    [eax] [edx] \
        value   [eax] \
...
int UnusedRandomFunction (int x, int y)
{
	int ret = unusedrndtable[unusedrndindex];
	unusedrndindex = (unusedrndindex+1)&0xff;
	ret = x + SemiFixedMulForRand(y<<8, ret-128);
	if (ret < 0)
		return ret + 256;
	if (ret > 255)
		return ret - 256;
